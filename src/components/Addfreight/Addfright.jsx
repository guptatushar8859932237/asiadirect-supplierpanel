...
const Addfright = () => {
  ...
  const apihit = () => {
    ...
    formdata.append("sales_representative", useridsales.id);
  ...
  const Volumetricweight = (e) => {
    if (e.charCode < 44 || e.charCode > 57) {
      e.preventDefault();
    }
    const volumetricweight12 = 167 * parseInt(data.dimension);
    console.log(volumetricweight12);
  };
